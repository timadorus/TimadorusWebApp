...
public class PremadeCharacterPanel extends FormPanel {
  ...
  public Character createTestCharacter() {
    ...
    final int lvlBn = 5;
    final int item = 6;
    Skill skill = new Skill("defLabelIn", "lvlBonusCatIn", "stat1In", "stat2In", "actionTypeIn", "calcTypeIn",
                            "localeDescLabelIn", "localeDescLanguageIn", true, "descriptionIn", cost, rank, rkBn,
                            statBn, lvlBn, item);
    skillList.add(skill);
