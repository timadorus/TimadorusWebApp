...
public class SelectFactionPanel extends FormPanel {
    ...
    class MyHandler implements ClickHandler {
      public void onClick(ClickEvent event) {
        ...
        if (event.getSource().equals(prevButton)) {
          ...
          ListIterator<Faction> factionIterator = entryIn.getTestValues().getFactions()
              .listIterator();
  ...
  public Faction getSelectedFaction() {
    ...
    while (factionIterator.hasNext()) {
      ...
      if (selectedClass.getName()
          .equals(factionListBox.getValue(factionListBox.getSelectedIndex()))) {
  ...
  public static SelectFactionPanel getSelectFactionPanel(TimadorusWebApp entry,
