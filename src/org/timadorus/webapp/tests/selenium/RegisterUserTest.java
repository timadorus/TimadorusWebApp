...
public class RegisterUserTest extends SeleneseTestCase {
  ...
  public void testRegisterUser() throws Exception {
    ...
    selenium.type("//div[@id='content']/form/table/tbody/tr[2]/td[2]/input", "1");
    selenium.type("//div[@id='content']/form/table/tbody/tr[3]/td[2]/input", "31.10.1988");
    selenium.type("//div[@id='content']/form/table/tbody/tr[4]/td[2]/input", "test1@home.de");
    selenium.type("//div[@id='content']/form/table/tbody/tr[5]/td[2]/input", "test1@home.de");
    selenium.type("//div[@id='content']/form/table/tbody/tr[6]/td[2]/input", "test1");
