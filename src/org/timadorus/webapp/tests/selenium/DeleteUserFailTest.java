...
public class DeleteUserFailTest extends SeleneseTestCase {
  ...
  public void testDeleteUserFail() throws Exception {
    ...
    selenium.type("//div[@id='content']/form/table/tbody/tr[2]/td[2]/input", "9");
    selenium.type("//div[@id='content']/form/table/tbody/tr[6]/td[2]/input", "test9");
    selenium.click("//button[@type='button']");
    selenium.click("link=Einloggen");
    selenium.type("//input[@type='text']", "test9");
