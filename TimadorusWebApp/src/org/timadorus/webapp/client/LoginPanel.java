					...
					public void onSuccess(String result) {
						if(result != null){
							if(result.equals(User.USER_INACTIVE)){
								...
								RootPanel.get("content").add(new HTML("<div id=\"info\" class=\"info\">Der angegebene User ist deaktiviert. Das kann mehrere Gr�nde haben<br />(Anmerkung vom Programmierer: Welche denn? Gesperrt durch Admin oder sowas ? Oder ist damit gemeint 'Registriert, aber Mail noch nicht verifiziert' ? Oder beides ?)</div>"));
