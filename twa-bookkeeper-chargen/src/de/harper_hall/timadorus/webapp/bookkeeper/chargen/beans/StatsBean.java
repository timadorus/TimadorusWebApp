...
import de.harper_hall.keeper.KeeperException;
...
import de.harper_hall.keeper.character.EntityNotSetException;
...
import de.harper_hall.keeper.ejb.interfaces.CharCreationException;
import de.harper_hall.keeper.ejb.interfaces.CharCreatorFacade;
import de.harper_hall.keeper.ejb.interfaces.CharacterFactory;
import de.harper_hall.keeper.ejb.interfaces.SkillLine;
...
public class StatsBean {
  ...
  public long getEntityID() throws EntityNotSetException, CharCreationException {
  ...
  public String addSkill() {
    ...
    try {
      ...
      log.error("invalid skill/subSkill name combo'" + addPickSkillName
          + "'. The validator should have handled this");
      return "failure";
    } catch (InsufficientDevPointException e) {
      log.error("insufficient development points :" + e.getMessage());
    } catch (ExternalDataException e) {
      log.error("an internal error has occoured " + e.getMessage());
      return "failure";
    }
