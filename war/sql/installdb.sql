...
(U2R_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL,
...
INSERT INTO "WEBAPP"."USER" (ACTIVATIONCODE, ACTIVE, DISPLAYNAME, EMAIL, GEBURTSTAG, NACHNAME, PASSWORD, USERNAME, VORNAME) values ('11111111111111111111111111111111', 'Y', 'admin', 'admin@timadorus', '01.01.1980', 'admin', 'admin', 'admin', 'admin');

INSERT INTO "WEBAPP"."ROLE" (TITLE) VALUES ('Admin');
INSERT INTO "WEBAPP"."ROLE" (TITLE) VALUES ('Gamemaster');
 
INSERT INTO "WEBAPP"."USER2ROLE" (USER_ID, ROLE_ID, AUTHORIZED_BY) VALUES (1,1,0);
